...
class Ui_DialogAnalysis(object):
    ...
    def setupUi(self, DialogAnalysis):
        ...
        #self.tabWidgetBookMark.addTab(graphics.piechart(Tasksss, my_labels,'graphs')
        #self.tabWidgetBookMark.addTab(self., ' ')
        ...
        self.lbl_Visualization.setGeometry(QtCore.QRect(0, 0, 951, 711))
        ...
        self.groupBox_7.setGeometry(QtCore.QRect(30, 720, 751, 80))
        ...
        self.groupBox_4.setGeometry(QtCore.QRect(0, 740, 791, 80))
        ...
        self.lbl_statistic.setGeometry(QtCore.QRect(20, 20, 761, 691))
        ...
        self.tabWidgetBookMark.addTab(graphics.piechart(self,Tasksss, my_labels),"statiscss")
        ...
        self.label_5.setGeometry(QtCore.QRect(-10, 30, 951, 871))
        self.label_5.setObjectName("label_5")
        self.plainTextEdit = QtWidgets.QPlainTextEdit(self.tab_tap)
        self.plainTextEdit.setGeometry(QtCore.QRect(0, 60, 961, 761))
        ...
        #self.btnVerify.clicked.connect(self.selected)
        ...
        self.tabWidgetBookMark.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(DialogAnalysis)
        # update check boxes
        self.checkBox_Email.stateChanged.connect(self.checked)
        self.checkBox_Viber.stateChanged.connect(self.checked)
        self.checkBox_WhatsApp.stateChanged.connect(self.checked)
    ...
    def retranslateUi(self, DialogAnalysis):
        ...
        #N=QtWidgets.QLineEdit(self.Case.caseName)
        #self.label_casename.setText(N)
        # image to the snapshpt putton
        self.btnSnapshot.setStyleSheet("background-image : url(Capture.PNG);")
     ...
     # to date functionality
        ...
        self.dateEdit_dateTo.dateTimeChanged.connect(lambda: methodTo(self))
        ...
        self.dateEdit_dateFrom.setMaximumDate(QtCore.QDate(2022, 3, 1))
        self.dateEdit_dateFrom.dateChanged.connect(self.fromlinedittopython)
        self.dateEdit_dateFrom.dateTimeChanged.connect(lambda: methodFrom(self))
        # btn screen shot
...
#g.piechart(Tasksss, my_labels)  
        ...
        self.tabWidgetBookMark.addTab(Canvas.d(self,Tasksss, my_labels),"statiscss")
