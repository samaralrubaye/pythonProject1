...
class Ui_DialogAnalysis(object):
    ...
    def setupUi(self, DialogAnalysis):
        ...
        self.lbl_Visualization.setPixmap(QtGui.QPixmap("c:\\Users\\samar\\Desktop\\finalyearproject\\pythonProject1\\view\\../../../../../../.designer/backup/filename4.png"))
        ...
        self.widget = QtWidgets.QWidget(self.statisictap)
        self.widget.setGeometry(QtCore.QRect(9, 29, 791, 691))
        ...
        self.tabWidgetBookMark.addTab(Window(),'statistc')
        ...
        self.tabWidgetBookMark.setCurrentIndex(2)
...
#g.piechart(Tasksss, my_labels)  
    ...
    def piechart(self):
        ...
        self.axis.plot(data, 'r-')
        self.axis.set_title('PyQt Matplotlib Example')
