...
class MyApp(QWidget):
    ...
    def __init__(self,vibers = None,emails = None,watsap = None):
       ...
       # self.WhatsAppgeographicLocation()
        ...
        if emails != None:
         self.EmailgeographicLocation(emails)
        if watsap!= None:
           self.WhatsAppgeographicLocation(watsap)
        if vibers != None :
           self.vibergeographicLocation(vibers)


    def EmailgeographicLocation(self,emails):
    ...
    def vibergeographicLocation(self,vibers):
    ...
    def WhatsAppgeographicLocation(self,WhatsApps):
