...
from BookMark2 import Ui_bookmark
   ...
   # def additemWindo(self):
    ...
    def setupUi(self, DialogAnalysis):
       ...
       "border-color: rgb(0, 0, 0);\n"
        ...
        self.lineEdit_serchKeyWord_ForChat.setGeometry(QtCore.QRect(90, 420, 181, 31))
        ...
        self.btnLogout = QtWidgets.QPushButton(self.dockWidgetContents_2)
        self.btnLogout.setGeometry(QtCore.QRect(20, 740, 111, 41))
        self.btnLogout.setStyleSheet("background-color: rgb(222, 223, 255);")
        self.btnLogout.setObjectName("btnLogout")
        self.groupBox_5 = QtWidgets.QGroupBox(self.dockWidgetContents_2)
        self.groupBox_5.setGeometry(QtCore.QRect(20, 570, 251, 101))
        ...
        self.groupBox_6.setGeometry(QtCore.QRect(20, 470, 251, 80))
...
"")
        ...
        self.btnshowResult.setGeometry(QtCore.QRect(20, 690, 251, 41))
  ...
  #  def fff(self):
    ...
    def retranslateUi(self, DialogAnalysis):
        ...
        self.btnLogout.setText(_translate("DialogAnalysis", "Logout"))
        ...
        self.label_4.setText(_translate("DialogAnalysis", "Recipient"))
        ...
        self.checkBox.setText(_translate("DialogAnalysis", "Filter by recipient"))
