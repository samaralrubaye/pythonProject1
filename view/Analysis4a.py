...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.dateEdit_fromdate = QtWidgets.QDateEdit(self.dockWidgetContents_2)
        self.dateEdit_fromdate.setGeometry(QtCore.QRect(90, 340, 110, 22))
        self.dateEdit_fromdate.setCalendarPopup(True)

        self.dateEdit_fromdate.setObjectName("dateEdit_fromdate")
        self.dateEdit_todate = QtWidgets.QDateEdit(self.dockWidgetContents_2)
        self.dateEdit_todate.setGeometry(QtCore.QRect(90, 400, 110, 22))
        self.dateEdit_todate.setObjectName("dateEdit_todate")
        self.dateEdit_todate.setCalendarPopup(True)

        self.label_2 = QtWidgets.QLabel(self.dockWidgetContents_2)
        self.label_2.setGeometry(QtCore.QRect(20, 400, 55, 16))
        self.label_2.setObjectName("label_2")
        self.label = QtWidgets.QLabel(self.dockWidgetContents_2)
        self.label.setGeometry(QtCore.QRect(20, 340, 61, 20))
