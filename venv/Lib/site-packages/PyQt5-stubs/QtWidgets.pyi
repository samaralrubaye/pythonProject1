...
class MyQwidgetItem(sip.wrapper):

    class ItemType(int): ...
    Type = ... # type: 'MyQwidgetItem.ItemType'
    UserType = ... # type: 'MyQwidgetItem.ItemType'
    ...
    @typing.overload
    def __init__(self, other: 'MyQwidgetItem') -> None: ...
...
class QTableWidget(QTableView):
    ...
    def isPersistentEditorOpen(self, item: MyQwidgetItem) -> bool: ...  # type: ignore[override]
    def dropEvent(self, event: QtGui.QDropEvent) -> None: ...
    def event(self, e: QtCore.QEvent) -> bool: ...
    def itemFromIndex(self, index: QtCore.QModelIndex) -> MyQwidgetItem: ...
    def indexFromItem(self, item: MyQwidgetItem) -> QtCore.QModelIndex: ...
    def items(self, data: QtCore.QMimeData) -> typing.List[MyQwidgetItem]: ...
    def supportedDropActions(self) -> QtCore.Qt.DropActions: ...
    def dropMimeData(self, row: int, column: int, data: QtCore.QMimeData, action: QtCore.Qt.DropAction) -> bool: ...
    def mimeData(self, items: typing.Iterable[MyQwidgetItem]) -> QtCore.QMimeData: ...
    def mimeTypes(self) -> typing.List[str]: ...
    ...
    def scrollToItem(self, item: MyQwidgetItem, hint: QAbstractItemView.ScrollHint = ...) -> None: ...
    def setItemPrototype(self, item: MyQwidgetItem) -> None: ...
    def itemPrototype(self) -> MyQwidgetItem: ...
    def visualItemRect(self, item: MyQwidgetItem) -> QtCore.QRect: ...
    @typing.overload
    def itemAt(self, p: QtCore.QPoint) -> MyQwidgetItem: ...
    @typing.overload
    def itemAt(self, ax: int, ay: int) -> MyQwidgetItem: ...
    def visualColumn(self, logicalColumn: int) -> int: ...
    def visualRow(self, logicalRow: int) -> int: ...
    def findItems(self, text: str, flags: typing.Union[QtCore.Qt.MatchFlags, QtCore.Qt.MatchFlag]) -> typing.List[MyQwidgetItem]: ...
    def selectedItems(self) -> typing.List[MyQwidgetItem]: ...
    ...
    def closePersistentEditor(self, item: MyQwidgetItem) -> None: ...  # type: ignore[override]
    def openPersistentEditor(self, item: MyQwidgetItem) -> None: ...  # type: ignore[override]
    def editItem(self, item: MyQwidgetItem) -> None: ...
    def isSortingEnabled(self) -> bool: ...
    def setSortingEnabled(self, enable: bool) -> None: ...
    ...
    @typing.overload
    def setCurrentItem(self, item: MyQwidgetItem) -> None: ...
    @typing.overload
    def setCurrentItem(self, item: MyQwidgetItem, command: typing.Union[QtCore.QItemSelectionModel.SelectionFlags, QtCore.QItemSelectionModel.SelectionFlag]) -> None: ...
    def currentItem(self) -> MyQwidgetItem: ...
    ...
    def takeHorizontalHeaderItem(self, column: int) -> MyQwidgetItem: ...
    def setHorizontalHeaderItem(self, column: int, item: MyQwidgetItem) -> None: ...
    def horizontalHeaderItem(self, column: int) -> MyQwidgetItem: ...
    def takeVerticalHeaderItem(self, row: int) -> MyQwidgetItem: ...
    def setVerticalHeaderItem(self, row: int, item: MyQwidgetItem) -> None: ...
    def verticalHeaderItem(self, row: int) -> MyQwidgetItem: ...
    def takeItem(self, row: int, column: int) -> MyQwidgetItem: ...
    def setItem(self, row: int, column: int, item: MyQwidgetItem) -> None: ...
    def item(self, row: int, column: int) -> MyQwidgetItem: ...
    def column(self, item: MyQwidgetItem) -> int: ...
    def row(self, item: MyQwidgetItem) -> int: ...
    def columnCount(self) -> int: ...
